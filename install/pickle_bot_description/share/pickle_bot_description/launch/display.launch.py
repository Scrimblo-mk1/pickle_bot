...
def generate_launch_description():
    pkg_share = launch_ros.substitutions.FindPackageShare(package='pickle_bot_description').find('pickle_bot_description')
    default_model_path = os.path.join(pkg_share, 'src/description/pickle_bot_description.urdf')
